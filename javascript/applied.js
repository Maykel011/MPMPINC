...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (missing) {
            openValidationModal('Please complete all required fields.');
            if (firstInvalid) {
                firstInvalid.focus();
            }
            return;
        ...
        // FIXED: careerbackend.php is in root folder
        fetch('../careerbackend.php', {
            method: 'POST',
            body: formData
        })
        ...
        .then(function(data) {
            ...
            if (data.success === true) {
                ...
                openSuccessModal('Application Submitted Successfully!', message);
                form.reset();
            } else {
                openValidationModal(data.message || 'There was an error processing your application. Please try again.');
            }
